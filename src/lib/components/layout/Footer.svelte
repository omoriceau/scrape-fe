    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="col-span-1 md:col-span-2">
        <div class="flex items-center space-x-2 mb-4">
          ...
          <span class="text-xl font-bold">ScrapeMaster</span>
        </div>
        <p class="text-gray-400 mb-4 max-w-md">
          {m.footer_description?.() || 'The most reliable web scraping service for developers and businesses. Extract data from any website with our powerful API.'}
        </p>
